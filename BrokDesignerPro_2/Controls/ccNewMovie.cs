...
namespace BrokDesignerPro_2.Controls
{
    ...
    ///
    ///     <MyNamespace:ccNewMovie/>
    ///
    /// </summary>
    public class ccNewMovie : Control
    {
        static ccNewMovie()
        {
            DefaultStyleKeyProperty.OverrideMetadata(typeof(ccNewMovie), new FrameworkPropertyMetadata(typeof(ccNewMovie)));
        }
    }
}

...
namespace BrokDesignerPro_2.Controls
{
    ...
    ///
    ///     <MyNamespace:ccTabControl/>
    ///
    /// </summary>
    public class ccTabControl : TabControl
    {
        static ccTabControl()
        {
            DefaultStyleKeyProperty.OverrideMetadata(typeof(ccTabControl), new FrameworkPropertyMetadata(typeof(ccTabControl)));
        }

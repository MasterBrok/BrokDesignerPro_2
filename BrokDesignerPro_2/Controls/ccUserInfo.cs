...
namespace BrokDesignerPro_2.Controls
{
    ...
    ///
    ///     <MyNamespace:ccUserInto/>
    ///
    /// </summary>
    public class ccUserInfo : Control
    {
        static ccUserInfo()
        {
            DefaultStyleKeyProperty.OverrideMetadata(typeof(ccUserInfo),
                new FrameworkPropertyMetadata(typeof(ccUserInfo)));
        }
    }
}
